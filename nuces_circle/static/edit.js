...
//         // when use click on checkbox for still working here 
...
//             // $(this).parents('.experience-checkbox').siblings('.date-div').find('.currrent-position').html('Present');
...
//         {
//             console.log("cp2");
//             // $(this).parents('.experience-checkbox').siblings('.date-div').find('.currrent-position').html('');
